...
export function SafariIcon({ size = 14 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
      <path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm0 1.5c4.687 0 8.5 3.813 8.5 8.5s-3.813 8.5-8.5 8.5-8.5-3.813-8.5-8.5 3.813-8.5 8.5-8.5zm.354 3.354l-5.5 9.5 9.5-5.5-4-4zm-.354 3.292a1.5 1.5 0 110 3 1.5 1.5 0 010-3z" />
    </svg>
  );
}
...
export function ChromeIcon({ size = 14 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.78 0 3.4.66 4.65 1.74L12 12l-4.65-5.26C8.6 5.66 10.22 5 12 5zm-7 7c0-1.78.66-3.4 1.74-4.65L12 12l-5.26 4.65C5.66 15.4 5 13.78 5 12zm7 7c-1.78 0-3.4-.66-4.65-1.74L12 12l4.65 5.26C15.4 18.34 13.78 19 12 19zm4.9-2.64L12 12l4.9-4.36c.7 1.1 1.1 2.4 1.1 3.86 0 1.96-.65 3.76-1.74 5.22l-.36-.36z" />
    </svg>
  );
}
...
export function FirefoxIcon({ size = 14 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm5.92 6.42c-.2-.76-.67-1.55-1.02-1.96.5.87.76 1.87.76 2.54 0 1.2-.33 1.98-.62 2.76-.45 1.2-.97 2.21-1.89 3.28-1.67 1.95-3.9 2.46-5.15 2.46-.83 0-2.5-.24-3.86-1.62-.6-.6-1.14-1.42-1.14-2.5 0-1.25.62-2.25 1.45-2.87.62-.47 1.38-.72 2.14-.8-.55.45-.92 1.17-.92 1.93 0 1.25.9 2.26 2 2.26.87 0 1.63-.56 1.91-1.36.32.22.75.36 1.22.36 1.24 0 2.24-1.14 2.24-2.55 0-.87-.4-1.63-.97-2.08 1.24-.14 2.43.44 3.04 1.36.3-.65.5-1.35.5-2.03 0-.4-.05-.77-.17-1.12.17.32.28.7.28 1.11 0 .51-.14.97-.35 1.36-.3.55-.9 1.17-1.45 1.17-.23 0-.44-.08-.62-.2.05 0 .1-.02.14-.02.75 0 1.36-.67 1.36-1.5 0-.24-.05-.46-.13-.67z" />
    </svg>
  );
}
